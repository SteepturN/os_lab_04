...
int main() {
	...
	int fd = Mmap::dont_have_fd;
	Mmap::get_mapped_area< int >( fd, mapping_length, mapped_area );
	std::cout << "parent: mapped_area = " << mapped_area << std::endl;
	char** exec_arg;
	ExecArg::make_execve_arg< int >( fd, pathname, exec_arg );
